        ...
        <div class="container-xxl">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Edit Clarifiy</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                                            ...
                                            <div class="card border mb-0">
                                                ...
                                                <div class="card-header">
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <h4 class="card-title mb-0">Edit Clarifiy</h4>
                                                        </div><!--end col-->
                                                    </div>
                                                </div>
                                                <form action="{{ route('update.slider') }}" method="POST"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <textarea name="description" class="form-control">{{ $clarifi->description }}</textarea>
                                                            </div>
                                                        </div>

                                                        <div class="form-group mb-3 row">
                                                            <label class="form-label">Clarifi Photo</label>
                                                            <div class="col-lg-12 col-xl-12">
