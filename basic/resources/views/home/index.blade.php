            ...
            <div class="row">
                ...
                <div class="col-lg-7 d-flex align-items-center">
                    <div class="lonyo-default-content pr-50" data-aos="fade-right" data-aos-duration="700">
                        ...
                        <p class="data">This feature ensures you can easily stay on top of your finances by
                            consolidating all updates into a single dashboard.</p>
                        <div class="mt-50">
                            <ul class="tabs">
                                <li class="active-tab">
                            ...
                            <ul class="tabs-content">
                                <li>
                                    View all your accounts, transactions & investments in one central location. See
                                    every credit & debit transaction as it happens across all your accounts. Get a
                                    complete view of your expenses with expense categories.
                                </li>
                                <li>
                                    This feature ensures you can easily stay on top of your finances by consolidating
                                    all updates into a single dashboard.View all your accounts, transactions iew of your
            ...
            <div class="lonyo-t-wrap wrap2 light-bg">
                ...
                <div class="lonyo-t-text">
                    <p>"This app transformed my budgeting! It has been a clear view longer have to worry of my It has
                        been success expenses and savings goals."</p>
                </div>
            ...
            <div class="lonyo-t-wrap wrap2 light-bg">
                ...
                <div class="lonyo-t-text">
                    <p>“The interface is intuitive, and I love how syncs with my bank accounts. I no longer have to
                        worry about manual tracking. Highly recommend!”</p>
                </div>
                <div class="lonyo-t-author">
                    <div class="lonyo-t-author-thumb">
            ...
            <div class="lonyo-t-wrap wrap2 light-bg">
                ...
                <div class="lonyo-t-text">
                    <p>"Having all my accounts in one place gives me complete control over my money. So user-friendly
                        and helpful! Highly recommend!"</p>
                </div>
                <div class="lonyo-t-author">
                    <div class="lonyo-t-author-thumb">
